...
class LikeArticleView(RedirectView):
    ...
    def get(self, *args, **kwargs):
        ...
        try:
            ...
            messages.add_message(self.request, messages.SUCCESS, 'You liked this article')
        except ValidationError:
            messages.add_message(self.request, messages.ERROR, 'Like only allowed once per article')
